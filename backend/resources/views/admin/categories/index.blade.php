...
@endif
    ...
    <tbody>
        @foreach ($categories as $category)
            <tr class="category-row" data-id="{{ $category->id }}">
                ...
                <td>
                    <a href="javascript:void(0)" class="text-primary category-name fw-bold">
                        {{ $category->name }}
                        <small class="text-muted ms-2">({{ $category->subcategories ? $category->subcategories->count() : 0 }} subcategories)</small>
                    </a>
                </td>
                <td>{{ $category->slug }}</td>
            ...
            <tr class="subcategory-row d-none" id="subcategories-{{ $category->id }}">
                <td colspan="7">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <div class="form-check form-switch">
                {{-- <input class="form-check-input" type="checkbox" id="customSlugToggle"> --}}
                {{-- <label class="form-check-label" for="customSlugToggle"> --}}
                  {{-- <small>Custom slug</small> --}}
                </label>
              </div>
            </div>
            <input type="text" name="slug" class="form-control" placeholder="auto-generated if left empty" readonly>
            {{-- <small class="form-text text-muted">Toggle "Custom slug" to edit manually</small> --}}
          </div>
