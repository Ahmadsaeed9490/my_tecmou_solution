                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                       ...
                       <td>
                            ...
                            <?php else: ?>
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label ms-2">
                                        <span class="badge status-badge bg-<?php echo e($user->status ? 'success' : 'danger'); ?>">
                        ...
                        <td>
                            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#editUserModal<?php echo e($user->id); ?>">Edit</button>
        ...
        <form method="POST" action="<?php echo e(route('admin.users.update', $user->id)); ?>" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row g-3">
                    <?php echo $__env->make('admin.users.partials.edit_user_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
   ...
   <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                <div class="modal-content">
                  ...
                  <?php echo $__env->make('admin.users.partials.add_user_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
$(document).ready(function () {
    $(document).on('change', '.toggle-user-status', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.users.toggleStatus')); ?>", // ✅ Correct route
            method: "POST",
            data: {
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\my_tecmou_solution\backend\resources\views/admin/users/index.blade.php ENDPATH**/ ?>