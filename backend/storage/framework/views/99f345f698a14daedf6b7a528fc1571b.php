...
<div class="container-fluid pt-4 px-4">
    ...
    <?php else: ?>
        <div class="form-check form-switch">
            <input type="checkbox"
                class="form-check-input toggle-product-status"
                data-id="<?php echo e($product->id); ?>"
                <?php echo e($product->status ? 'checked' : ''); ?>>
            <span class="badge product-status-badge <?php echo e($product->status ? 'bg-success' : 'bg-danger'); ?>">
...
<td>
    ...
    <?php else: ?>
        ...
        <button onclick="deleteProduct(<?php echo e($product->id); ?>)" class="btn btn-sm btn-danger">Delete</button>
    <?php endif; ?>
</td>
