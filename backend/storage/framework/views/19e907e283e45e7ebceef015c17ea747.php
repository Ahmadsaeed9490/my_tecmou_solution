      ...
      <div class="col-md-6 mt-4">
          <div class="card border-0 h-100 card-shadow p-3">
              <div class="row align-items-center">
                  ...
                  <div class="col-md-5">
                      <img src="<?php echo e(asset('assets/img/overview.png')); ?>" class="img-fluid" alt="" />
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="row">
              <div class="col-md-6 mt-4">
                  <a href="sale.html" class="text-decoration-none">
                      <div class="card-shadow border rounded d-flex align-items-center p-3">
                          <img src="<?php echo e(asset('assets/img/content-sale.svg')); ?>" class="img-fluid text-center"
                              alt="" />
                          <div class="ms-3">
              ...
              <div class="col-md-6 mt-4">
                  <a href="purchase.html" class="text-decoration-none">
                      <div class="card-shadow border rounded d-flex align-items-center p-3">
                          <img src="<?php echo e(asset('assets/img/content-bag.svg')); ?>" class="img-fluid text-center"
                              alt="" />
                          <div class="ms-3">
          ...
          <div class="row">
              <div class="col-md-6 mt-4">
                  <a href="#" class="text-decoration-none">
                      <div class="card-shadow border rounded d-flex align-items-center p-3">
                          <img src="<?php echo e(asset('assets/img/content-right-arrow.svg')); ?>" class="img-fluid text-center"
                              alt="" />
                          <div class="ms-3">
              ...
              <div class="col-md-6 mt-4">
                  <a href="#" class="text-decoration-none">
                      <div class="card-shadow border rounded d-flex align-items-center p-3">
                          <img src="<?php echo e(asset('assets/img/content-left-arrow.svg')); ?>" class="img-fluid text-center"
                              alt="" />
                          <div class="ms-3">
                              <p class="mb-1 fs-6 text-muted subheading">
                                  Purchase Return
          ...
          <div class="card-shadow text-center rounded p-4 card border-0 h-100">
              <div class="row card-header border-0 bg-white">
                  ...
                  <div class="col-md-6 col-12 d-flex flex-wrap text-end justify-content-end">
                      ...
                      <img src="<?php echo e(asset('assets/img/calendar.svg')); ?>" class="calendar-icon rounded-3 me-1"
      ...
      <div class="col-12 col-md-5 mt-4">
          <div class="card-shadow rounded p-4 px-3 w-100 card border-0 h-100">
              <div class="card-header bg-white p-0 m-0 d-flex justify-content-between">
                  ...
                  <img src="<?php echo e(asset('assets/img/help-icon.svg')); ?>" class="img-fluid" alt="" />
              </div>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\my_tecmou_solution\backend\resources\views/home.blade.php ENDPATH**/ ?>