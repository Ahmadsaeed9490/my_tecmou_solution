                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('pages.shopGridLeftSidebar') }}">shop</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="product-details-des mt-md-34 mt-sm-34">
                                        <h3><a href="{{ route('pages.product.details') }}">external product 12</a></h3>
                                        <div class="ratings">
                                        ...
                                        Phasellus id nisi quis justo tempus mollis sed et dui. In hac habitasse platea dictumst. Suspendisse ultrices mauris diam. Nullam sed aliquet elit. Mauris consequat nisi</p>
                            ...
                            <div class="featured-carousel-active slick-padding slick-arrow-style">
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="{{ route('pages.product.details') }}">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="{{ route('pages.product.details') }}">affiliate product</a></h4>
                                        <div class="pricebox">
                                ...
                                <div class="product-item fix">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="{{ route('pages.product.details') }}">simple product 01</a></h4>
                                        <div class="pricebox">
                                ...
                                <div class="product-item fix">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="{{ route('pages.product.details') }}">vertual product 05</a></h4>
                                        <div class="pricebox">
                                ...
                                <div class="product-item fix">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="{{ route('pages.product.details') }}">grouped product</a></h4>
                                        <div class="pricebox">
                                ...
                                <div class="product-item fix">
                                    ...
                                    <div class="product-content">
                                        <h4><a href="{{ route('pages.product.details') }}">simple product 10</a></h4>
                                        <div class="pricebox">
                                ...
                                <div class="category-carousel-active row" data-row="4">
                                    <div class="col">
                                        <div class="category-item">
                                            ...
                                            <div class="category-content">
                                                <h4><a href="{{ route('pages.product.details') }}">Virtual Product 01</a></h4>
                                                <div class="price-box">
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            ...
                                            <div class="category-content">
                                                <h4><a href="{{ route('pages.product.details') }}">external Product 01</a></h4>
                                                <div class="price-box">
                                                    <div class="regular-price">
                                                        $140.00
                                                    </div>
