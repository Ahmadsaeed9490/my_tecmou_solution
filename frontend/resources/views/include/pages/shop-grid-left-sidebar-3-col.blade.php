                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">shop left sidebar 3 col</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="shop-product-wrap grid row">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item fix mb-30">
                                        ...
                                        <div class="product-content">
                                            <h4><a href="{{ route('pages.product.details') }}">vertual product 01</a></h4>
                                            <div class="pricebox">
                                    ...
                                    <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="{{ route('pages.product.details') }}">virtual product 02</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="{{ route('pages.product.details') }}">simple product 02</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item fix mb-30">
                                        ...
                                        <div class="product-content">
                                            <h4><a href="{{ route('pages.product.details') }}">group product 01</a></h4>
                                            <div class="pricebox">
                                                <span class="regular-price">$70.00</span>
                                                <div class="ratings">
                                                    <span class="good"><i class="fa fa-star"></i></span>
                                    ...
                                    <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="{{ route('pages.product.details') }}">group product 02</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item fix mb-30">
                                        ...
                                        <div class="product-content">
                                            <h4><a href="{{ route('pages.product.details') }}">external product</a></h4>
                                            <div class="pricebox">
                                                <span class="regular-price">$70.00</span>
                                                <div class="ratings">
                                                    <span class="good"><i class="fa fa-star"></i></span>
                                    ...
                                    <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="{{ route('pages.product.details') }}">external product</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item fix mb-30">
                                        ...
                                        <div class="product-content">
                                            <h4><a href="{{ route('pages.product.details') }}">smart product 01</a></h4>
                                            <div class="pricebox">
                                                <span class="regular-price">$70.00</span>
                                                <div class="ratings">
                                                    <span class="good"><i class="fa fa-star"></i></span>
                                    ...
                                    <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="{{ route('pages.product.details') }}">smart product 02</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
