                                    ...
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="single-product.php" class="image">
                                                <img class="img-fluid" src="assets/img/product/product-img4.jpg"
                                                    alt="Compare Product">
                                            </a>
                                            <a href="#" class="category">Daimond</a>
                                            <a href="single-product-sale.php" class="title">wet food</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="single-product.php" class="image">
                                                <img class="img-fluid" src="assets/img/product/product-img5.jpg"
                                                    alt="Compare Product">
                                            </a>
                                            <a href="#" class="category">Gold</a>
                                            <a href="single-product-group.php" class="title">organic food</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="single-product.php" class="image">
                                                <img class="img-fluid" src="assets/img/product/product-img2.jpg"
                                                    alt="Compare Product">
                                            </a>
                                            <a href="#" class="category">Ring</a>
                                            <a href="single-product.php" class="title">dry food</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="first-column">Description</td>
                                        <td class="pro-desc">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident nulla,
                                                explicabo iste a rerum pariatur.</p>
                                        </td>
                                        <td class="pro-desc">
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit commodi
                                                obcaecati cumque consectetur alias incidunt?</p>
                                        </td>
                                        <td class="pro-desc">
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eius, facere.
                                                Fuga asperiores inventore iste tempora.</p>
                                        </td>
                                    </tr>
                                    <tr>
